          ...
          <div className="space-y-2 bg-card p-3 rounded border">
            ...
            {selectedModel === 'both' && (
              <div className="mt-3 pt-3 border-t">
                <p className="text-xs font-medium text-slate-700 mb-2">Execution Mode</p>
                <RadioGroup value={executionMode} onValueChange={(v) => onExecutionModeChange(v as any)}>
                  <div className="space-y-1">
                    <Label className="flex items-center gap-2 p-1 rounded hover:bg-muted/50 cursor-pointer">
                      ...
                      <span className="text-xs">Concurrent (faster)</span>
                    </Label>
                    <Label className="flex items-center gap-2 p-1 rounded hover:bg-muted/50 cursor-pointer">
                      <RadioGroupItem value="sequential" />
                      <span className="text-xs">Sequential (lower load)</span>
                    </Label>
                  </div>
                </RadioGroup>
              </div>
