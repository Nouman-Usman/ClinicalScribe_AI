      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-sm max-w-none text-muted-foreground space-y-6">
          <section>
            ...
            <p>
              By accessing and using the AiroDx application, you accept and agree to be bound 
          ...
          <section>
            ...
            <p>
              ...
              on AiroDx for personal, non-commercial transitory viewing only. This is the grant of 
          ...
          <section>
            ...
            <p>
              The materials on AiroDx are provided on an "as is" basis. AiroDx makes no 
          ...
          <section>
            ...
            <p>
              In no event shall AiroDx or its suppliers be liable for any damages (including, without 
              limitation, damages for loss of data or profit, or due to business interruption) arising out of the 
              use or inability to use the materials on AiroDx, even if we or an authorized representative 
          ...
          <section>
            ...
            <p>
              The materials appearing on AiroDx could include technical, typographical, or photographic 
              errors. AiroDx does not warrant that any of the materials on its Application are accurate, 
              complete, or current. AiroDx may make changes to the materials contained on its Application 
          ...
          <section>
            ...
            <p>
              AiroDx has not reviewed all of the sites linked to its Application and is not responsible 
              for the contents of any such linked site. The inclusion of any link does not imply endorsement by 
              AiroDx of the site. Use of any such linked website is at the user's own risk.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              AiroDx may revise these Terms and Conditions for its Application at any time without 
